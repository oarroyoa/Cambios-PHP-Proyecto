    ...
    <main class="aumentarMargin100">
        <form>
            <div id="contenido">
                    ...
                    <?php
                        ...
                        foreach ($tabla as $fila) {
                            ...
                            echo "<tr>
                                    ...
                                    <td><a href=index.php?id=".$fila['idCategoria']."&accion=tablaCategoria&controlador=categoria class=sinEstilo><img src='../img/IonEye.svg' class=icono></a></td>
                ...
                <a href="index.php?controlador=categoria&accion=insertarCategoria" class="submit">Añadir Categoría</a>
            </div>
        </form>
    </main>