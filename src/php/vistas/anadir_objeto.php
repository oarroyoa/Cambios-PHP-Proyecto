...
<body>
    ...
    <main class="aumentarMargin100">
        <form method='post' action="index.php?accion=anadir_objeto&controlador=objeto" enctype="multipart/form-data">
                ...
                foreach ($objetosExistentes as $indice => $objeto) {
                    ...
                    <div class="contenedores">
                        ...
                        <p>
                            ...
                            <select id="selectBueno" name="bueno[]">
                                <option value="1" <?php echo ($objeto['valoracion'] == 1) ? 'selected' : ''; ?>>No</option>
                                <option value="0" <?php echo ($objeto['valoracion'] == 0) ? 'selected' : ''; ?>>Si</option>
                            </select>
                        </p>
                        <a href="index.php?accion=remove&id=<?php echo $id; ?>&controlador=controlador&funcion=objeto&idCategoria=<?php echo $idCategoria; ?>" class="submit">Borrar</a>
                    </div>
