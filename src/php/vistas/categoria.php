    ...
    <body>
        ...
        <main class="aumentarMargin100">
            ...
            ?>
                ...
                ?>
                    <a class="submit" href="index.php?controlador=categoria&accion=actualizarTablero&id=<?php echo $_GET['id'];?>">Modificar</a>
                ...
                <table>
                    ...
                    /* Tablas de las Preguntas */
                        if(isset($_GET['id'])){
                            foreach($objPregunta->tablaPregunta($id) as $fila){
                                echo '<tr>
                                    <td>'.$fila['texto'].'</td>
                ...
                <table>
                    ...
                    /* Tablas de los Objetos */
                        if(isset($_GET['id'])){
                            foreach($objObjeto->tablaObjeto($id) as $fila){
